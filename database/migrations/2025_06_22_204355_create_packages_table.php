...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('packages', function (Blueprint $table) {
            ...
            $table->decimal('price'); // Price of the package
            ...
            $table->text('features')->nullable(); // Features included in the package, stored as JSON or text .. needs to be json becuase i used repeatetor 
