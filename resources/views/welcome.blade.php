...
<body class="bg-zinc-950 text-white antialiased selection:bg-orange-500 selection:text-white">
    ...
    <nav class="fixed w-full z-50 bg-zinc-950/80 backdrop-blur-md border-b border-zinc-800">
        <div class="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
            ...
            <div class="flex items-center gap-4">
                @auth
                    <a href="{{ url('/admin') }}"
                        class="px-5 py-2.5 text-sm font-semibold text-white bg-orange-600 rounded-lg hover:bg-orange-700 transition shadow-lg shadow-orange-900/20">
                        Dashboard
                    </a>
                @else
                    ...
                    <a href="{{ route('register') }}"
                        class="px-5 py-2.5 text-sm font-semibold text-white bg-white text-zinc-950 rounded-lg hover:bg-zinc-200 transition">
                        Join Now
                    </a>
                @endauth
            </div>
    ...
    <section class="relative pt-32 pb-20 lg:pt-48 lg:pb-32 overflow-hidden">
        ...
        <div
            class="absolute top-0 left-1/2 -translate-x-1/2 w-[1000px] h-[500px] bg-orange-600/20 rounded-full blur-[120px] -z-10">
        </div>
        ...
        <div class="max-w-7xl mx-auto px-6 text-center">
            ...
            <div class="flex flex-col sm:flex-row items-center justify-center gap-4">
                <a href="{{ route('register') }}"
                    class="w-full sm:w-auto px-8 py-4 bg-orange-600 text-white font-bold rounded-xl hover:bg-orange-700 transition shadow-lg shadow-orange-600/25">
                    Start Free Trial
                </a>
                <a href="#programs"
                    class="w-full sm:w-auto px-8 py-4 bg-zinc-900 border border-zinc-800 text-white font-bold rounded-xl hover:bg-zinc-800 transition">
                    View Programs
                </a>
            </div>
        </div>
    ...
    <section id="programs" class="py-24 bg-zinc-950">
        <div class="max-w-7xl mx-auto px-6">
            ...
            <div class="grid md:grid-cols-3 gap-8">
                <!-- Feature 1 -->
                <div
                    class="p-8 rounded-2xl bg-zinc-900 border border-zinc-800 hover:border-orange-500/50 transition group">
                    <div
                        class="w-12 h-12 bg-orange-500/10 rounded-lg flex items-center justify-center mb-6 group-hover:bg-orange-500/20 transition">
